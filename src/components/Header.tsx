    ...
    <header className="bg-white border-b border-zinc-200/80 text-zinc-900 sticky top-0 z-30 shadow-2xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Sync Status, Google Login & Action */}
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="hidden md:flex items-center px-3 py-1.5 rounded-xl bg-zinc-50 border border-zinc-200/80 text-xs text-zinc-700 gap-2">
